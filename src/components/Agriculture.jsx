        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                <div className="relative h-64 overflow-hidden sm:h-80 lg:h-full">
                    <img
                        alt=" Agri gif"
                        src="/assets/images/animationvegetable.gif"
                    ...
                    <article className="space-y-4 text-gray-600 text-right">
                        <div className="max-w-3xl">
                            <div className="flex justify-end">
                                <img src="/assets/images/Agri-business.png" alt="Agri-business" />
                            <img className="h-20" src="/assets/images/agriicon.png" alt="" />
                            </div>
                        </div>
